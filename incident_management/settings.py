...
SECRET_KEY = 'django-insecure-fc6q1-2wo+m&0_s!)ki@(x-(0@pegq1ace^8i=s7t$1+&w0y2^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tickets.context_processors.incident_counts',
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    'tickets.auth_backend.EmailOrUsernameModelBackend',
